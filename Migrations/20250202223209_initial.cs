    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LandmarksLandmarkId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ToursTourId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LandmarkTour", x => new { x.LandmarksLandmarkId, x.ToursTourId });
                    table.ForeignKey(
                        name: "FK_LandmarkTour_Landmarks_LandmarksLandmarkId",
                        column: x => x.LandmarksLandmarkId,
                        principalTable: "Landmarks",
                        principalColumn: "LandmarkId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LandmarkTour_Tours_ToursTourId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LandmarkTour_ToursTourId",
                table: "LandmarkTour",
                column: "ToursTourId");
